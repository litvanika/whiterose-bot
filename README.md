...
- [How to make an hourly Twitter (X) bot (with images) for free. Tutorial:](#how-to-make-an-hourly-twitter-x-bot-with-images-for-free-tutorial)
   * [Step 1. Create a new Twitter account for your bot](#step-1-create-a-new-twitter-account-for-your-bot)
   * [Step 2. Get developer access](#step-2-get-developer-access)
   * [Step 3. Add automated label to your bot account](#step-3-add-automated-label-to-your-bot-account)
   * [Step 4. Edit authentication settings](#step-4-edit-authentication-settings)
   * [Step 5. Generate secret keys](#step-5-generate-secret-keys)
   * [Step 6. Collect images](#step-6-collect-images)
   * [Step 7. Set up python](#step-7-set-up-python)
   * [Step 8. Write python script](#step-8-write-python-script)
   * [Step 9. Create a repository on Github](#step-9-create-a-repository-on-github)
   * [Step 10. Add more images / Update code](#step-10-add-more-images-update-code)
   * [Step 11. Add secret keys to GitHub](#step-11-add-secret-keys-to-github)
   * [Step 12. Test your bot](#step-12-test-your-bot)
   * [Step 13. Create a GitHub token for a cron job](#step-13-create-a-github-token-for-a-cron-job)
   * [Step 14. Create a cron-job](#step-14-create-a-cron-job)

# How to make an hourly Twitter (X) bot (with images) for free. Tutorial:
...
## Step 1. Create a new Twitter account for your bot
...
## Step 3. Add automated label to your bot account
...
## Step 4. Edit authentication settings
...
Now make sure that the secret keys from [Step 4](#step-4-edit-authentication-settings) and saved somewhere NOT in the `twitter_bot` folder. The keys are secret and should be available ONLY to you.
...
## Step 10. Add more images / Update code
...
> **Remember to always follow this Step when you update your images/videos or code or other files!**

## Step 11. Add secret keys to GitHub
...
Now add the keys from [Step 4](#step-4-edit-authentication-settings) with the following names:
...
## Step 13. Create a GitHub token for a cron job
...
> **Unfortunately, you have to return to this Step and create a new GitHub token every year**

## Step 14. Create a cron-job
...
Fill all the other fills in the `Common` tab according to your preferences (I recommend leaving the `Execution schedule` setting as `Every 60 minutes` as Twitter only allows up to 1500 tweets per month).
...
| Authorization | Bearer <Your GitHub token from [Step 13](#step-13-create-a-github-token-for-a-cron-job)> |

> **You'll need too update the `Authorization` header every time you regenerate or generate a new GitHub token from [Step 13](#step-13-create-a-github-token-for-a-cron-job).**
...
> **Remember to always follow [Step 10](#step-10-add-more-images-update-code) when you update your images/videos or code or other files!**

> **And don't forget to regenerate GitHub token from [Step 13](#step-13-create-a-github-token-for-a-cron-job) and update the `Authorization` header once a year**
